...
context('Screenshot script', () => {
  it('FIIRST CHAPTERS - 2.3', () => {
    ...
    uix.appNavigation.bookmarks.openWindowManag();
  ...
  it('RUN + DESK-Window Management', () => {
    ...
    uix.topBar.changeStatusTo('editing');
    cy.wait(1000);
    uix.pages.desk.windowManagement.page.editingWindow.addWindow('Characters', 'ocrb 75 2mm TV1', 'New Window', true);
    uix.pages.desk.windowManagement.page.button.discard();
    uix.dialog.unsavedChanges('Yes');
    cy.wait(1000);
  ...
  it('DESK - Fonts', () => {
    ...
    cy.wait(1000);
    uix.pages.desk.fonts.section.character();
    cy.wait(1000);
    ...
    uix.topBar.changeStatusTo('idle');
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.bookmarks.openFonts();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.fonts.button.edit();
    //MAP of the characters
    uix.pages.desk.fonts.section.map().takeEvidence('Map - Fonts');
    cy.wait(1000);
    //Screenshot PARAMETERS of the characters
    uix.pages.desk.fonts.section.parameters().takeEvidence('Parameters -Fonts');
    cy.wait(1000);
    //Screenshot TOLERANCES of the characters
    uix.pages.desk.fonts.section.tolerances().takeEvidence('Tolerances - Fonts');
    cy.wait(1000);
  ...
  it('DESK - Batch configuration', () => {
    ...
    cy.wait(1000);
    //Printers
    uix.pages.desk.batchConfiguration.selectTab('Printers');
    ...
    //Standard AIs
    uix.pages.desk.batchConfiguration.selectTab('Standard AIs').takeEvidence('Standard AIs section');
    cy.wait(1000);
    //Material Items
    uix.pages.desk.batchConfiguration.selectTab('Material Items').takeEvidence('Material Items section');
    cy.wait(1000);
  });
  ...
  it('desk - System Parameters and Users', () => {
    ...
    uix.pages.desk.users.edit.enablingPermission('User management');
    uix.pages.desk.users.edit.enablingPermission('Editing level 1');
    uix.pages.desk.users.edit.enablingPermission('Article choice');
    cy.wait(500);
    cy.get('.page-title-bar').takeEvidence('Permission section');
    uix.pages.desk.users.edit.selectTab('Functions');
    uix.pages.desk.users.edit.enablingFunctions('5 - Automatic');
    cy.wait(1000);
  ...
  it('View - Dashboard', () => {
    ...
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeTo.CounterPie('Counter (Gauge)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeTo.Counter('Counter (Pie)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterOption('FIFO OUT');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.batchInfoOption();
    cy.wait(1000);
    uix.pages.view.dashboard.configure.changeTo.CounterPie('Counter');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(1000);
    ...
    uix.clcikScreen.realClick();
    uix.pages.view.dashboard.page.configureDashboard();
    uix.pages.view.dashboard.configure.changeTo.CounterGauge('Counter (Pie)');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.counterGaugeOption('1 CARTON SGTIN');
    uix.pages.view.dashboard.configure.buttons.apply();
    cy.wait(1000);
  ...
  it('View-Cameras and Track and Trace and Counters', () => {
    ...
    uix.pages.view.trackTrace.tablePage.selectId('CARTON SGTIN', 'IDs out of machine or aggreg. complete');
    cy.wait(2000);

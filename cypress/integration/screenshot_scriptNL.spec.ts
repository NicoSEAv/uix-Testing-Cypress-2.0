...
context('Screenshot script', () => {
  it('FIIRST CHAPTERS - 2.3', () => {
    ...
    uix.topBar.checkCurrentStatus('Inactief', { takeEvidence: true });
    ...
    //Navigation Bar
    cy.wait(500);
    uix.pages.view.dashboard.page.checkDashboardPage('Inactief').takeEvidence('Navigation SideBar');
    uix.appNavigation.modules.openRun();
    uix.pages.run.batchMgmt.closeBatch(true);
    uix.appNavigation.bookmarksNL.openWindowManag();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.windowManagement.page.editingWindow.addWindow('Tekens', '1 - ocrb 75 2mm TV1', 'NEW WINDOW', false);
    cy.wait(1000);
  ...
  it('RUN + DESK-Window Management', () => {
    ...
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.modules.openDesk();
    uix.pages.desk.home.navigateToNL.windowManagPage();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.windowManagement.page.button.snapshot();
    ...
    uix.topBar.changeStatusTo('editing');
    cy.wait(1000);
    uix.pages.desk.windowManagement.page.editingWindow.addWindow('Tekens', 'ocrb 75 2mm TV1', 'New Window', true);
    uix.pages.desk.windowManagement.page.button.discard();
    uix.dialog.unsavedChanges('Yes');
    cy.wait(1000);
  ...
  it('DESK - Fonts', () => {
    ...
    cy.wait(1000);
    uix.pages.desk.fonts.section.characterNL();
    cy.wait(1000);
    ...
    uix.topBar.changeStatusTo('idle');
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.bookmarksNL.openFonts();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.fonts.button.edit();
    //MAP of the characters
    uix.pages.desk.fonts.section.mapNL().takeEvidence('Map - Fonts');
    cy.wait(1000);
    //Screenshot PARAMETERS of the characters
    uix.pages.desk.fonts.section.parametersNL().takeEvidence('Parameters -Fonts');
    cy.wait(1000);
    //Screenshot TOLERANCES of the characters
    uix.pages.desk.fonts.section.tolerancesNL().takeEvidence('Tolerances - Fonts');
    cy.wait(1000);
  ...
  it('DESK - Batch configuration', () => {
    ...
    cy.wait(1000);
    //Printers
    uix.pages.desk.batchConfiguration.selectTabNL('Printers');
    ...
    //Standard AIs
    uix.pages.desk.batchConfiguration.selectTabNL('Aangepaste AI’s').takeEvidence('Standard AIs section');
    cy.wait(1000);
    //Material Items
    uix.pages.desk.batchConfiguration.selectTabNL('Materiaalitems').takeEvidence('Material Items section');
    cy.wait(1000);
  });
  ...
  it('desk - System Parameters and Users', () => {
    ...
    uix.pages.desk.users.edit.enablingPermissionNL('Artikel vervangen');
    uix.pages.desk.users.edit.enablingPermissionNL('Programmering niveau 1');
    uix.pages.desk.users.edit.enablingPermissionNL('Gebruikers administratie');
    cy.wait(500);
    cy.get('.page-title-bar').takeEvidence('Permission section');
    uix.pages.desk.users.edit.selectTab('Functions');
    uix.pages.desk.users.edit.enablingFunctions('5 - Automatisch');
    cy.wait(1000);
  ...
  it('View - Dashboard', () => {
    ...
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeToNL.CounterPie('Teller (Meter)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeToNL.Counter('Teller (Cirkeldiagram)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterOption('FIFO OUT');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.batchInfoOption();
    cy.wait(1000);
    uix.pages.view.dashboard.configure.changeToNL.CounterPie('Teller');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(1000);
    ...
    uix.clcikScreen.realClick();
    uix.pages.view.dashboard.page.configureDashboard();
    uix.pages.view.dashboard.configure.changeToNL.CounterGauge('Teller (Cirkeldiagram)');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.counterGaugeOption('1 CARTON SGTIN');
    uix.pages.view.dashboard.configure.buttons.apply();
    cy.wait(1000);
  ...
  it('View-Cameras and Track and Trace and Counters', () => {
    ...
    uix.pages.view.trackTrace.tablePage.selectId('CARTON SGTIN', 'ID’s uit machine of aggreg. compleet (72)');
    cy.wait(2000);

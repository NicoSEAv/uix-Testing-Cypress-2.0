...
context('Screenshot script', () => {
  it('FIIRST CHAPTERS - 2.3', () => {
    ...
    // -------------------------------------------------   Use Deutsch   ---------------------------------------------------------------------------------------------------------------
    // Set Deutsch before launching Cypress
    cy.wait(3000);
    ...
    uix.topBar.checkCurrentStatus('Leerlauf', { takeEvidence: true });
    ...
    uix.appNavigation.bookmarksDE.openWindowManag();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.windowManagement.page.editingWindow.addWindow('Zeichen', '1 - ocrb 75 2mm TV1', 'NEW WINDOW', false);
    cy.wait(1000);
  ...
  it('RUN + DESK-Window Management', () => {
    ...
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.modules.openDesk();
    uix.pages.desk.home.navigateToDE.windowManagPage();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.windowManagement.page.button.snapshot();
    ...
    uix.topBar.changeStatusTo('editing');
    cy.wait(1000);
    uix.pages.desk.windowManagement.page.editingWindow.addWindow('Zeichen', 'ocrb 75 2mm TV1', 'New Window', true);
    uix.pages.desk.windowManagement.page.button.discard();
    uix.dialog.unsavedChanges('Yes');
    cy.wait(1000);
  ...
  it('DESK - Fonts', () => {
    ...
    cy.wait(1000);
    uix.pages.desk.fonts.section.characterDE();
    cy.wait(1000);
    ...
    uix.topBar.changeStatusTo('idle');
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.bookmarksDE.openFonts();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.fonts.button.edit();
    //MAP of the characters
    uix.pages.desk.fonts.section.mapDE().takeEvidence('Map - Fonts');
    cy.wait(1000);
    //Screenshot PARAMETERS of the characters
    uix.pages.desk.fonts.section.parametersDE().takeEvidence('Parameters -Fonts');
    cy.wait(1000);
    //Screenshot TOLERANCES of the characters
    uix.pages.desk.fonts.section.tolerancesDE().takeEvidence('Tolerances - Fonts');
    cy.wait(1000);
  });
  ...
  it('DESK - Batch configuration', () => {
    ...
    cy.wait(1000);
    //Printers
    uix.pages.desk.batchConfiguration.selectTabDE('Drucker');
    ...
    //Standard AIs
    uix.pages.desk.batchConfiguration.selectTabDE('Standard-AIs').takeEvidence('Standard AIs section');
    cy.wait(1000);
    //Material Items
    uix.pages.desk.batchConfiguration.selectTabDE('Materialartikel').takeEvidence('Material Items section');
    cy.wait(1000);
  });
  ...
  it('Custom Warning Example', () => {
    ...
    cy.wait(1000);
    uix.pages.view.cameras.button.acquisitionButtonDE('Schnappschuss', 'active');
    cy.get('sv-acquisition-button .fa-ellipsis-v').click();
    cy.wait(1000);
    cy.get('.cdk-overlay-pane').find('span .icon-expand-check').click();
    cy.wait(3000);
  ...
  it('desk - System Parameters and Users', () => {
    ...
    uix.pages.desk.users.edit.enablingPermissionDE('Usermanagement');
    uix.pages.desk.users.edit.enablingPermissionDE('Bearbeiten ersten Ebene');
    uix.pages.desk.users.edit.enablingPermissionDE('Formatwahl');
    cy.wait(500);
    cy.get('.page-title-bar').takeEvidence('Permission section');
    uix.pages.desk.users.edit.selectTab('Functions');
    uix.pages.desk.users.edit.enablingFunctions('5 - Automatik');
    cy.wait(1000);
  ...
  it('View - Dashboard', () => {
    ...
    uix.appNavigation.modules.openView();
    cy.wait(2000);
    uix.pages.view.dashboard.page.checkDashboardPage('Bereit');
    cy.wait(1000);
    ...
    cy.wait(1000);
    uix.pages.view.dashboard.configure.cameraOption('Kamera 1');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterGaugeOption('1 CARTON SGTIN');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeToDE.CounterPie('Zähler (Spur)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeToDE.Counter('Zähler (Stk.)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterOption('FIFO OUT');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.batchInfoOption();
    cy.wait(1000);
    uix.pages.view.dashboard.configure.changeToDE.CounterPie('Zähler');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(1000);
    ...
    uix.clcikScreen.realClick();
    uix.pages.view.dashboard.page.configureDashboard();
    uix.pages.view.dashboard.configure.changeToDE.CounterGauge('Zähler (Stk.)');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.counterGaugeOption('1 CARTON SGTIN');
    uix.pages.view.dashboard.configure.buttons.apply();
    cy.wait(1000);
  ...
  it('View-Cameras and Track and Trace and Counters', () => {
    ...
    uix.pages.view.measureResults.tv.Kamera3();
    ...
    uix.pages.view.trackTrace.tablePage.selectId(
      'CARTON SGTIN',
      'IDs außerhalb der Maschine oder Aggregation abgeschlossen'
    );
    cy.wait(2000);

...
context('Screenshot script', () => {
  it('FIIRST CHAPTERS - 2.3', () => {
    ...
    uix.topBar.checkCurrentStatus('Inactif', { takeEvidence: true });
    ...
    uix.appNavigation.bookmarksFR.openWindowManag();
  ...
  it('RUN + DESK-Window Management', () => {
    ...
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.modules.openDesk();
    uix.pages.desk.home.naviagteToFR.windowManagPage();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.windowManagement.page.button.snapshot();
    ...
    uix.topBar.changeStatusTo('editing');
    cy.wait(1000);
    uix.pages.desk.windowManagement.page.editingWindow.addWindow('Caractères', 'ocrb 75 2mm TV1', 'New Window', true);
    uix.pages.desk.windowManagement.page.button.discard();
    uix.dialog.unsavedChanges('Yes');
    cy.wait(1000);
  ...
  it('DESK - Fonts', () => {
    ...
    cy.wait(1000);
    uix.pages.desk.fonts.section.characterFR();
    cy.wait(1000);
    ...
    uix.topBar.changeStatusTo('idle');
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.bookmarksFR.openFonts();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.fonts.button.edit();
    //MAP of the characters
    uix.pages.desk.fonts.section.mapFR().takeEvidence('Map - Fonts');
    cy.wait(1000);
    //Screenshot PARAMETERS of the characters
    uix.pages.desk.fonts.section.parametersFR().takeEvidence('Parameters -Fonts');
    cy.wait(1000);
    //Screenshot TOLERANCES of the characters
    uix.pages.desk.fonts.section.tolerancesFR().takeEvidence('Tolerances - Fonts');
    cy.wait(1000);
  });
  ...
  it('DESK - Batch configuration', () => {
    ...
    cy.wait(1000);
    //Printers
    uix.pages.desk.batchConfiguration.selectTabFR('Imprimantes');
    ...
    //Standard AIs
    uix.pages.desk.batchConfiguration.selectTabFR('AI Standard').takeEvidence('Standard AIs section');
    cy.wait(1000);
    //Material Items
    uix.pages.desk.batchConfiguration.selectTabFR('Codes des Materiaux').takeEvidence('Material Items section');
    cy.wait(1000);
  });
  ...
  it('desk - System Parameters and Users', () => {
    ...
    uix.pages.desk.users.edit.enablingPermissionFR('Administration utilisateurs');
    uix.pages.desk.users.edit.enablingPermissionFR('Programmation niveau 1');
    uix.pages.desk.users.edit.enablingPermissionFR('Changement article');
    cy.wait(500);
    cy.get('.page-title-bar').takeEvidence('Permission section');
    uix.pages.desk.users.edit.selectTab('Functions');
    uix.pages.desk.users.edit.enablingFunctions('5 - Automatique');
    cy.wait(1000);
  ...
  it('View - Dashboard', () => {
    ...
    cy.wait(1000);
    uix.pages.view.dashboard.configure.cameraOption('Caméra 2');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterGaugeOption('1 CARTON SGTIN');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeToFR.CounterPie('Compteur (Jauge)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeToFR.Counter('Compteur (Pcs)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterOption('FIFO OUT');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.batchInfoOption();
    cy.wait(1000);
    uix.pages.view.dashboard.configure.changeToFR.CounterPie('Compteur');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(1000);
    ...
    uix.clcikScreen.realClick();
    uix.pages.view.dashboard.page.configureDashboard();
    uix.pages.view.dashboard.configure.changeToFR.CounterGauge('Compteur (Pcs)');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.counterGaugeOption('1 CARTON SGTIN');
    uix.pages.view.dashboard.configure.buttons.apply();
    cy.wait(1000);
  ...
  it('View-Cameras and Track and Trace and Counters', () => {
    ...
    uix.pages.view.measureResults.tv.Caméra3();
    ...
    uix.pages.view.trackTrace.tablePage.selectId('CARTON SGTIN', 'ID hors machine ou aggreg. complete');
    cy.wait(2000);

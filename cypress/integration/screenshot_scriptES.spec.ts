...
context('Screenshot script', () => {
  it('FIIRST CHAPTERS - 2.3', () => {
    ...
    uix.topBar.checkCurrentStatus('Inactivo', { takeEvidence: true });
    ...
    uix.appNavigation.bookmarksES.openWindowManag();
  ...
  it('RUN + DESK-Window Management', () => {
    ...
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.modules.openDesk();
    uix.pages.desk.home.navigateToES.windowManagPage();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.windowManagement.page.button.snapshot();
    ...
    uix.topBar.changeStatusTo('editing');
    cy.wait(1000);
    uix.pages.desk.windowManagement.page.editingWindow.addWindow('Caracteres', 'ocrb 75 2mm TV1', 'New Window', true);
    uix.pages.desk.windowManagement.page.button.discard();
    uix.dialog.unsavedChanges('Yes');
    cy.wait(1000);
  ...
  it('DESK - Fonts', () => {
    ...
    cy.wait(1000);
    uix.pages.desk.fonts.section.charactersES();
    cy.wait(1000);
    ...
    uix.topBar.changeStatusTo('idle');
    uix.pages.run.batchMgmt.openBatchMI('TT PRE-CENTER', '%01%01234567890128%10%LOTTO_123%17%201212%37%1000', false);
    uix.appNavigation.bookmarksES.openFonts();
    uix.topBar.changeStatusTo('editing');
    uix.pages.desk.fonts.button.edit();
    //MAP of the characters
    uix.pages.desk.fonts.section.mapES().takeEvidence('Map - Fonts');
    cy.wait(1000);
    //Screenshot PARAMETERS of the characters
    uix.pages.desk.fonts.section.parametersES().takeEvidence('Parameters -Fonts');
    cy.wait(1000);
    //Screenshot TOLERANCES of the characters
    uix.pages.desk.fonts.section.tolerancesES().takeEvidence('Tolerances - Fonts');
    cy.wait(1000);
  });

  it.only('DESK - ProgrammableMeasure', () => {
    uix
      .setup()
      .asExpertUser()
  ...
  it('DESK - Batch configuration', () => {
    ...
    cy.wait(1000);
    //Printers
    uix.pages.desk.batchConfiguration.selectTabES('Impresoras');
    ...
    //Standard AIs
    uix.pages.desk.batchConfiguration.selectTabES('AIs estándares').takeEvidence('Standard AIs section');
    cy.wait(1000);
    //Material Items
    uix.pages.desk.batchConfiguration.selectTabES('Material Item').takeEvidence('Material Items section');
    cy.wait(1000);
  });
  ...
  it('desk - System Parameters and Users', () => {
    ...
    uix.pages.desk.users.edit.enablingPermissionES('Administración usuarios');
    uix.pages.desk.users.edit.enablingPermissionES('Programación nivel 1');
    uix.pages.desk.users.edit.enablingPermissionES('Cambio artículo');
    cy.wait(500);
    cy.get('.page-title-bar').takeEvidence('Permission section');
    uix.pages.desk.users.edit.selectTab('Functions');
    uix.pages.desk.users.edit.enablingFunctions('5 - Automático');
    cy.wait(1000);
  ...
  it('View - Dashboard', () => {
    ...
    cy.wait(1000);
    uix.pages.view.dashboard.configure.cameraOption('Cámara 1');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterGaugeOption('1 CARTON SGTIN');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeToES.CounterPie('Contador (calibre)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.changeToES.Counter('Contador (Tarta)');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterOption('FIFO OUT');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.batchInfoOption();
    cy.wait(1000);
    uix.pages.view.dashboard.configure.changeToES.CounterPie('Contador');
    cy.wait(3000);
    uix.pages.view.dashboard.configure.counterPieOption('2 CASE SGTIN');
    cy.wait(1000);
    ...
    uix.clcikScreen.realClick();
    uix.pages.view.dashboard.page.configureDashboard();
    uix.pages.view.dashboard.configure.changeToES.CounterGauge('Contador (Tarta)');
    cy.wait(1000);
    uix.pages.view.dashboard.configure.counterGaugeOption('1 CARTON SGTIN');
    uix.pages.view.dashboard.configure.buttons.apply();
    cy.wait(1000);
  ...
  it('View-Cameras and Track and Trace and Counters', () => {
    ...
    uix.pages.view.measureResults.tv.Càmara3();
    ...
    uix.pages.view.trackTrace.tablePage.selectId('CARTON SGTIN', 'ID fuera de máquina o agreg. completa');
    cy.wait(2000);
